...
**829,262 sales transactions across 50 toy stores in Mexico were analyzed in PostgreSQL/SQL and reported in Power BI/DAX.**

The analysis covers growth, product concentration and profitability, differences across store locations, and current inventory.
...
- **Category rankings differ by metric and store location.** Toys generated the highest total category profit at about **$1.08M**, while Electronics had the highest profit margin at about **44.6%**. Electronics led category profit in Airport and Commercial locations; Toys led in Downtown and Residential locations.
...
- **The inventory snapshot contains 29,742 units and 77 explicit zero-stock records; 157 of 1,750 theoretical store-product combinations are absent.** Absent combinations are treated as missing records, not as zero stock. Estimated inventory value is about **$300K at cost** and **$410K at retail price**.
...
- [`analysis_queries.sql`](sql/analysis_queries.sql) – contains queries for monthly trends, January–September year-over-year comparisons, product concentration, product and category profitability, individual stores, store locations, and peak sales days.
...
- April 30 was a high-revenue date in both years. April 30, 2023 had the highest daily revenue in the dataset (**$66.8K**), while April 30, 2022 generated **$47.5K**. April 30 is Mexico's annual *Día de la Niña y el Niño*; this provides external context for the pattern but does not establish causality.
